...
from ansible_collections.a10.acos_cli.plugins.module_utils.network.a10.argspec.lacp.lacp import (
    LacpArgs,
)
...
class LacpFacts(object):
    ...
    def render_config(self, spec, conf):
        ...
        config['system']['priority'] = str(int((conf.split(',')[0][7:]), 16))
